...
; RUN:   | opt --enable-new-pm=0 -load %shlibdir/RIV%shlibext -load %shlibdir/DuplicateBB%shlibext -legacy-duplicate-bb -S -o - \
; RUN:   | opt --enable-new-pm=0 -load  %shlibdir/MergeBB%shlibext -legacy-merge-bb -S -o %t.ll
